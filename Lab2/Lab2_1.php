    ...
    <body>
        ...
        <form action="Lab2_1.php" method="post" >
            ...
            <tr>
                ...
                <input type="text" name="so_dau" id="textfield" value="<?php if(isset($so_dau)) echo $so_dau ?>"/></td>
                <td width="152">Số kết thúc</td>
                <td width="175"><label for="textfield2"></label>
                <input type="text" name="so_cuoi" id="textfield2" value="<?php if(isset($so_cuoi)) echo $so_cuoi ?>"/></td>
            </tr>
            <tr>
